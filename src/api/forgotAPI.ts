...
const messageStart: string = `<div style="background:#eee;padding:30px;">
...
export const forgotAPI = {
  sendLetter: async (email: string, name: string) => {
    const message = messageStart + `Dear <b>${name}</b>.` + messageEnd
