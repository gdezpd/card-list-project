...
export const ErrorIcon = ({ width = DEFAULT_SIZE, height = DEFAULT_SIZE }: IconType) => {
  return (
    <svg
    ...
    >
      <path
        d="M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22
